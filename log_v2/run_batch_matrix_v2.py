...
# This runner lives inside log_v2/, but the C# bridge modules
# (sabberstone_simulator, sim_rich, decks_v2) live one level up. Make the
# parent directory importable before importing them.
...
# Runner now lives inside log_v2/, so logs go directly into its own dir.
DEFAULT_LOG_ROOT = SCRIPT_DIR
...
def run_smoke(log_root=None, max_retries=6):
    log_root = log_root or os.path.join(_PARENT_DIR, "log_v2_smoke")
